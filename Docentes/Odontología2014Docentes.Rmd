...
data.docentes <- read.csv("/home/ceapo1905/Documents/1 Science/1 Dirección de Investigaciones Científicas/Autoevaluación Institucional/Ciencias Jurídicas/Derecho/Derecho2014Docentes.csv")
```
...
```{r questions}
source("/home/ceapo1905/Documents/1 Science/1 Dirección de Investigaciones Científicas/Autoevaluación Institucional/Ciencias Jurídicas/Derecho/Docentes/DocentesQ.R")
```
